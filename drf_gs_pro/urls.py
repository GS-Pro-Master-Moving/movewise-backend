...
urlpatterns = [
    ...
    path('assigns/<int:pk>/', ControllerAssign.as_view({'get': 'retrieve'}), name='assign-detail'),
    path('assigns-delete/<int:operator_id>/', ControllerAssign.as_view({'delete': 'delete'}), name='assign-detail'),
